...
<div class="form-group">
    ...
    <div class="col-md-9">
        ...
        @if(!empty($blog->photo))
        <img src="{{it()->url($blog->photo)}}" style="width:150px;height:150px;" />
        @endif
    </div>
</div>
<br>
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::text('title', $blog->title ,['class'=>'form-control','placeholder'=>trans('admin.title')]) !!}
    </div>
</div>
<br>
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::textarea('des', $blog->des ,['class'=>'form-control','placeholder'=>trans('admin.des')]) !!}
    </div>
</div>
<br>
