...
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::text('title', $services->title ,['class'=>'form-control','placeholder'=>trans('admin.title')]) !!}
    </div>
</div>
<br>
<div class="form-group">
    ...
    <div class="col-md-9">
        {!! Form::textarea('des', $services->des ,['class'=>'form-control','placeholder'=>trans('admin.des')]) !!}
    </div>
</div>
<br>
<div class="form-group">
    ...
    <div class="col-md-9">
        ...
        <img src="{{it()->url($services->photo)}}" style="width:150px;height:150px;" />
        @endif
    </div>
</div>
<br>
