...
class TeamDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.team.buttons.actions')
            ->addColumn('image', 'admin.team.buttons.image')
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'instgram',
                 'data'=>'instgram',
                 'title'=>trans('admin.instgram'),
		    ],
				[
                 'name'=>'linkedin',
                 'data'=>'linkedin',
                 'title'=>trans('admin.linkedin'),
		    ],
				[
                 'name'=>'image',
                 'data'=>'image',
