...
class PropertiesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ...
            ->addColumn('photo', 'admin.properties.buttons.photo')

            ->addColumn('type', '{{ trans("admin.".$type) }}')
    ...
    {
        return Property::query()->with(['place_id',])->select("properties.*");
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name' => 'rooms',
                'data' => 'rooms',
                'title' => trans('admin.rooms'),
            ],
            [
                'name' => 'wc',
                'data' => 'wc',
                'title' => trans('admin.wc'),
            ],
            [
                'name' => 'space',
                'data' => 'space',
                'title' => trans('admin.space'),
            ],
            [
                'name' => 'type',
                'data' => 'type',
            ...
            [
                'name' => 'place_id.name',
                'data' => 'place_id.name',
                'title' => trans('admin.place_id'),
            ],
            [
                'name' => 'badge',
                'data' => 'badge',
                'title' => trans('admin.badge'),
            ],
